...
# built documents.
#
from veros_bgc import __version__ as module_version
...
latex_documents = [
    (master_doc, 'veros-bgc.tex', u'Veros-BGC Documentation',
...
man_pages = [
    (master_doc, 'Veros-BGC', u'Veros-BGC Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'Veros-BGC', u'Veros-BGC Documentation',
     author, 'Veros-BGC', 'A biogeochemistry plug-in for Veros',
     'Miscellaneous'),
]
